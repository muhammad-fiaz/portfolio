  ...
  return (
    <div className="max-w-4xl mx-auto p-6 text-black dark:text-white">
      ...
      <ul className="list-disc ml-6 mb-4">
        ...
        <li className="mb-2">
          <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to {siteConfig.author}, {siteConfig.github_org_name}, or any related organization.
          </p>
        </li>
        <li className="mb-2">
        ...
        <li className="mb-2">
          <p><strong>Service</strong> refers to the Website, any or all apps, websites, software, and services we provide.</p>
        </li>
        <li className="mb-2">
        ...
        <li className="mb-2">
          <p><strong>Website</strong> refers to {siteConfig.author}, {siteConfig.github_org_name}, or any other related organizations, accessible from <Link href={siteConfig.baseUrl}
                                                                                                                                            rel="external nofollow noopener"
                                                                                                                                            target="_blank"
                                                                                                                                            className="underline text-blue-600">{siteConfig.domain}</Link> or any subdomains under it, and all social and profile links.
          </p>
        </li>
        <li className="mb-2">
      ...
      <ul className="list-disc ml-6 mb-4">
        <li className="mb-2"><strong>Cookies or Browser Cookies.</strong> A cookie is a small file placed on Your
          Device. You can instruct Your browser to refuse all Cookies or to indicate when a Cookie is being sent.
          However, if You do not accept Cookies, You may not be able to use some parts of our Service. Unless you have
          adjusted Your browser setting so that it will refuse Cookies, our Service may use Cookies.
        </li>
        <li className="mb-2"><strong>Web Beacons.</strong> Certain sections of our Service and our emails may contain
          small electronic files known as web beacons (also referred to as clear gifs, pixel tags, and single-pixel
          gifs) that permit the Company, for example, to count users who have visited those pages or opened an email and
          for other related website statistics (for example, recording the popularity of a certain section and verifying
      ...
      <p className="mb-4">
        ...
        browser. You can learn more about cookies on <Link href="https://www.termsfeed.com/blog/cookies/#What_Are_Cookies"
                                                        target="_blank" className="underline text-blue-600">TermsFeed
        website</Link> article.
      </p>
      <p className="mb-4">
      ...
      <ul className="list-disc ml-6 mb-4">
        <li className="mb-2"><strong>With Service Providers:</strong> We may share Your personal information with
          Service Providers to monitor and analyze the use of our Service, to contact You.
        </li>
        <li className="mb-2"><strong>For business transfers:</strong> We may share or transfer Your personal information
          in connection with, or during negotiations of, any merger, sale of Company assets, financing, or acquisition
          of all or a portion of Our business to another company.
        </li>
        <li className="mb-2"><strong>With Affiliates:</strong> We may share Your information with Our affiliates, in
        ...
        <li className="mb-2"><strong>With business partners:</strong> We may share Your information with Our business
          partners to offer You certain products, services or promotions.
        </li>
        <li className="mb-2"><strong>With other users:</strong> when You share personal information or otherwise
        ...
        <li className="mb-2"><strong>With Your consent:</strong> We may disclose Your personal information for any other
      ...
      <p className="mb-4">
        ...
        <ul className="list-disc list-inside">
          <li>By email: <Link href={`mailto:${siteConfig.social.email}`}
                           className="text-blue-500 hover:underline">{siteConfig.social.email}</Link></li>
          <li>By visiting this page on our website: <Link href={`https://${siteConfig.domain}/contact`}
                                                       className="text-blue-500 hover:underline" target="_blank"
                                                       rel="external nofollow noopener">{`https://${siteConfig.domain}/contact`}</Link>
          </li>
        </ul>
      </div>
