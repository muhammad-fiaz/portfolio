...
export default function TermsOfService() {
  return (
    <div className="max-w-4xl mx-auto p-6 text-black dark:text-white">
      ...
      <p className="text-black/40 dark:text-white/40 mb-4">Last updated: February 23, 2025</p>
      ...
      <ul className="list-disc ml-6 mb-4">
        ...
        <li className="mb-2">
          <p><strong>Country</strong> refers to: {siteConfig.country}</p>
        </li>
        <li className="mb-2">
          <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to {siteConfig.author}, {siteConfig.github_org_name}, or any related organization..</p>
        </li>
        <li className="mb-2">
        ...
        <li className="mb-2">
          <p><strong>Website</strong> refers to {siteConfig.author}, {siteConfig.github_org_name}, or any related organization., accessible from <Link href={siteConfig.baseUrl} rel="external nofollow noopener" target="_blank" className="underline text-blue-600">{siteConfig.domain}</Link> or any subdomains under it, and all social and profile links.</p>
        </li>
        <li className="mb-2">
      ...
      <ul className="list-disc ml-6 mb-4">
        <li className="mb-2">
          <p>By email: <a href={`mailto:${siteConfig.social.email}`} className="text-blue-500 hover:underline">{siteConfig.social.email}</a></p>
        </li>
        <li className="mb-2">
          <p>By visiting this page on our website: <Link href={`https://${siteConfig.domain}/contact`} className="text-blue-500 hover:underline" target="_blank" rel="external nofollow noopener">{`https://${siteConfig.domain}/contact`}</Link></p>
        </li>
      </ul>
    </div>
  );
